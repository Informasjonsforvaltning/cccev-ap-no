...
| URI |cv:issuingPlace
| Verdiområde / _Range_ | https://data.norge.no/specification/cpsv-ap-no#Adresse[dct:Location &#x29C9;, window="_blank", role="ext-link"]
| Anvendelse / _Usage note_ |Egenskapen brukes til å referere til stedet der dokumentasjonen er utstedt. F.eks. belgiske ID-kort utstedes i Belgia.
