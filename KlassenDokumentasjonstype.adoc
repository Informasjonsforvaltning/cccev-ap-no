...
| Anvendelse / _Usage note_ | Egenskapen brukes til å referere til kategorien som dokumentasjonen tilhører.

_This property represents the category to which the Evidence belongs._
...
==== Dokumentasjonstype – tillatt gyldighetsperiode (cccevno:permissibleValidityDuration) [[Dokumentasjonstype-tillatt-gyldighetsperiode]]

[cols="30s,70d"]
|===
| _English name_ |  _validity duration_
| URI | cccevno:permissibleValidityDuration
|Verdiområde / _Range_ | xsd:duration
| Anvendelse / _Usage note_ | Egenskapen brukes til å angi en tidsperiode som dokumentasjonstypen skal være gyldig innenfor.

_This property represents time duration within which the Evidence Type must be valid._
...
<påkrevdFirmaattest> a cccevno:RequiredEvidence ; 
   cccevno:permissibleValidityDuration "P6M"^^xsd:duration ; . # 6 måneder
-----

==== Dokumentasjonstype – tillatt språk (cccevno:permissibleLanguage) [[Dokumentasjonstype-tillatt-språk]]

[cols="30s,70d"]
|===
| _English name_ | _language_
| URI | cccevno:permissibleLanguage
|Verdiområde / _Range_ | dct:LinguisticSystem
| Anvendelse / _Usage note_ | Egenskapen brukes til å oppgi språk som dokumentasjonen kan være på.
...
| Anvendelse / _Usage note_ |  Egenskapen brukes til å referere til datasett som denne aktuelle type dokumentasjon kan være beskrevet i.
...
==== Dokumentasjonstype – gir understøttende opplysning (cv:supportsValue) [[Dokumentasjonstype-gir-understøttende-opplysning]]
...
| Anvendelse / _Usage note_ | Egenskapen brukes til å referere til understøttende opplysninger i den aktuelle type dokumentasjon.

_This property represents Supported Value that the given type of evidences may contain._
| Multiplisitet / _Multiplicity_ | 0..n
| Kravnivå / _Requirement level_ | Valgfri / _Optional_
|===
...
==== Dokumentasjonstype – understøtter informasjonsbegrep (cv:supportsConcept) [[Dokumentasjonstype-understøtter-informasjonsbegrep]]
...
| Anvendelse / _Usage note_ | Egenskapen brukes til å referere til informasjonsbegrep som gir fakta funnet eller utledet fra den aktuelle type dokumentasjon.

_This property is used to refer toInformation Concept providing facts found/inferred from the given type of evidences._
| Multiplisitet / _Multiplicity_ | 0..n
| Kravnivå / _Requirement level_ | Valgfri / _Optional_
|===


==== Dokumentasjonstype – understøtter krav (cv:supportsRequirement) [[Dokumentasjonstype-understøtter-krav]]
...
| Anvendelse / _Usage note_ | Egenskapen brukes til å referere til krav som den aktuelle type dokumentasjon understøtter, representert ved instans av en av subklassene til klassen Krav (`cv:Requirement`).

_This property is used to refer to the requirement that the given type of evidences support, represented by an instance of one of the subclasses of the class Requirement (`cv:Requirement`)._
| Multiplisitet / _Multiplicity_ | 0..n
| Kravnivå / _Requirement level_ | Valgfri / _Optional_
|===
