...
==== Begrensning – har dokumentasjonstype (cv:hasEvidenceType) [[Begrensning-har-dokumentasjonstype]]
...
| Anvendelse / _Usage note_ |  Egenskapen brukes til å referere til dokumentasjonstype som spesifiserer type dokumentasjon som trengs for å tilfredsstille begrensningen.

_This property is used to refer to the Evidence Type that specifies the type of evidence that is needed to meet the Constraint._
| Multiplisitet / _Multiplicity_ | 0..n
|Kravnivå / _Requirement level_ | Valgfri / _Optional_
|===
