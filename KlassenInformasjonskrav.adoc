...
==== Informasjonskrav – har påkrevd dokumentasjon (cccevno:hasRequiredEvidence) [[Informasjonskrav-har-påkrevd-dokumentasjon]]
...
| Anvendelse / _Usage note_ |  Egenskapen brukes til å spesifisere en påkrevd dokumentasjon som kan supplere med informasjon, bevis eller understøtte informasjonskravet.

_This property is used to specify a required evidence that may supply information, proof or support for the Information Requirement._
| Multiplisitet / _Multiplicity_ | 0..n
| Kravnivå / _Requirement level_ | Valgfri / _Optional_
