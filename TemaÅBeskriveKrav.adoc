...
CCCEV-AP-NO gjør det mulig, i struktuert og maskinlesbar form, å beskrive betingelser som skal oppfylles og dokumentasjon av oppfyllelse.
...
*** *Dokumentasjonstype* 1: Registrert opplysning i Folkeregisteret
