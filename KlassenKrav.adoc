...
| Merknad / _Note_ | Norsk utvidelse: I samsvar med CPSV-AP, er kravnivået endret fra valgfri til obligatorisk og multiplisiteten fra 0..n til 1..1. 

_Norwegian extension: Confirming to CPSV-AP, the requirement level changed from optional to mandatory, and the multiplicity from 0..n to 1..1._
|===
...
| Kravnivå / _Requirement level_ | Obligatorisk / _Mandatory_
| Merknad / _Note_ | Norsk utvidelse: I samsvar med CPSV-AP, er kravnivået endret fra valgfri til obligatorisk, multiplisiteten fra 0..n til 1..n, og verdiområdet fra 'xsd:string' til 'rdf:langString'.

_Norwegian extension: Confirming to CPSV-AP, the requirement level changed from optional to mandatory, the multiplicity from 0..n to 1..n, and the range from 'xsd:string' to 'rdf:langString'._
|===
...
| Anvendelse / _Usage note_ | Egenskapen brukes til å referere til en dokumentasjon som supplerer med informasjon, bevis eller understøtter kravet.

_This property refers to an evidence that supplies information, proof or support for the requirement._
| Multiplisitet / _Multiplicity_ | 0..n
| Kravnivå / _Requirement level_ | Valgfri / _Optional_
|===
