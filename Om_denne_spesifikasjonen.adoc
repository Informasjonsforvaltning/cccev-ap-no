...
* <<del1>> gir en introduksjon for ikke‑tekniske lesere, med en overordnet og forenklet fremstilling av kravene i denne spesifikasjonen. 
* <<del2>> retter seg mot tekniske lesere som skal utvikle eller tilpasse verktøy.
