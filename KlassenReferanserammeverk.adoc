...
| Merknad / _Note_ | Vanlige referanserammeverk er regulative og ikke-regulative spesifikasjoner. Eksempler kan være prosedyrer, anskaffelsesreglement osv.
...
| Eksempel |  Se under <<Å-kytte-krav-til-regelverk>>.
|===

Eksempel i RDF Turtle: Se under <<Å-kytte-krav-til-regelverk>>.
...
| Merknad 2 / _Note 2_ | Norsk utvidelse: For referanser til lovdata BØR ELI-URI-er brukes. Se https://lovdata.no/eli/[Lovdata sin implementering av ELI &#x29C9;, window="_blank", role="ext-link"] for mer informasjon.

__Norwegian extension: For references to Lovdata, ELI URIs SHOULD be used. See https://lovdata.no/eli/[ELI implementation at Lovdata &#x29C9;, window="_blank", role="ext-link"] for more information.__
|===
...
| Merknad / _Note_ | Norsk utvidelse: Ikke eksplisitt tatt med i CCCEV/CPSV-AP.
