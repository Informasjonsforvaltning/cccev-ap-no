...
CCCEV-AP-NO kan brukes til å beskrive både krav og dokumentasjon av kravoppfyllelse:
...
* Beskrivelse av dokumentasjon av kravoppfyllelse:
...
** *Dokumentasjonstype* og *Dokumentasjonstypeliste* brukes til, i «_design-time_», å oppgi typer dokumentasjon som _skal_ fremlegges og brukes til å evaluere om et krav er oppfylt eller ikke. Dokumentasjonstype og dokumentasjonstypeliste brukes med andre ord i forbindelse med _beskrivelsen_ av en tjeneste, i f.eks. en tjenestekatalog. Eksempler på en dokumentasjonstype kan være «Fødselsattest».
