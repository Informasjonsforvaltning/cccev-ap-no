...
** *Dokumentasjon* brukes til, i «_runtime_», å oppgi den _faktiske_ dokumentasjonen som _er_ fremlagt og brukt til å evaluere om et krav er oppfylt eller ikke. Dokumentasjon brukes med andre ord i et konkret sakshehandlingsøyemed, i f.eks. et saksbehandlings- eller arkiveringssystem. Eksempel på en faktisk dokumentasjon kan være «Uttrekk fra Folkeregisteret for Ola Nordmann».
