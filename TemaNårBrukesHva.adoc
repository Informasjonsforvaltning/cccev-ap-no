...
.Flytskjema for når Kriterium, Informasjonskrav eller Begrensning bør brukes.
[link=images/Flytskjema-kriterium-informasjonskrav-begrensning.png]
image::images/Flytskjema-kriterium-informasjonskrav-begrensning.png[alt="Flytskjema som viser når Kriterium, Informasjonskrav eller Begrensning bør brukes. Innholdet i flytskjemaet er forklart i teksten."]
