== Forenklet fremstilling av noen av kravene i CCCEV-AP-NO [[del1]]
...
** *Informasjonbskrav* brukes til å oppgi data som forespøres og som skal dokumentere en eller flere fakta, eller som fører til kilden til slik dokumentasjon. Eksempel på et informasjonskrav kan være «Søkerens alder». For å kunne i maskinlesbar form beskrive dataene som forespørres, brukes Informasjonskrav sammen med *Informasjonsbegrep*, f.eks. «Alder (i antall år)».
** *Begrensning* brukes til å oppgi begrensning som gjelder for et informasjonsbegrep. For informasjonsbegrepet «Alder (i antall år)» kan en begrensning være «Minst 18 år».
...
* *Påpkrevd dokumentasjon* brukes til, i «design-time», å oppgi den påkrevde dokumentasjonen som kan brukes til å evaluere om et krav er oppfylt eller ikke. Eksempel på en påkrved dokumentasjon kan være «Fødselsattest». Påpkrevd dokumentasjon brukes med andre ord i forbindelse med _beskrivelse_ av en tjeneste, i f.eks. en tjenestekatalog.

Se ellers <<Når-brukes-hva>> for mer forklaring på når Kriterium, Informasjonskrav eller Begrensning bør brukes.

Hvilke typer opplysninger som SKAL (obligatoriske), BØR (anbefalte) og KAN (valgfrie) tas med i en beskrivelse av et krav eller en dokumentasjon av kravoppfyllelse er nærmere spesifisert i det følgende i dette kapittelet. Hvordan opplysningene skal representeres teknisk i RDF (https://www.w3.org/RDF/[Resource Description Framework &#x29C9;, window="_blank", role="ext-link"]) er spesifisert i <<del2>>. <<del2>> innehlder også flere klasser som kan brukes i tillegg til de som er vist i <<img-ForenkletModell>> og beskrevet i dette kapittelet.
...
|===
| Obligatorisk | Forklaring | Ref. til <<del2>>
...
[cols="20s,65d,15d", options="header"]
|===
| Anbefalt | Forklaring | Ref. til <<del2>>
...
[cols="20s,65d,15d", options="header"]
|===
| Valgfri | Forklaring | Ref. til <<del2>>
...
|===
| Obligatorisk | Forklaring | Ref. til <<del2>>
| forventet verdi | forventet datatype formulert i et formelt språk som informasjonsbegrepet skal være i samsvar med | <<Informasjonsbegrep-uttrykk-av-forventet-verdi>>
|===
