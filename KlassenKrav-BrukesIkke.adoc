...
==== Krav – er subkrav av (cv:isRequirementOf) [[Krav-er-subkrav-av]]
...
==== Krav – innfri regel (cv:fulfils) [[Krav-innfrir-regel]]
...
| Anvendelse / _Usage note_ | Egenskapen brukes til å referere til regel som kravet innfrir.
