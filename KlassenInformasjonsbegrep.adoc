...
| Multiplisitet / _Multiplicity_ | 0..1
| Kravnivå / _Requirement level_ | Valgfri / _Optional_
|Merknad / _Note_ | I tillegg til <<Informasjonsbegrep-uttrykk-av-forventet-verdi>>, KAN denne egenskapen brukes til å uttrykke type verdi. Det kan være primitive typer som dato eller tekststreng, men også forretningsmessige domeneterminologier som «alder» eller «antall ansatte». Det anbefales at bruken av denne egenskapen er godt dokumentert.  
