...
==== Kriterium – har dokumentasjonstype (cv:hasEvidenceType) [[Kriterium-har-dokumentasjonstype]]

[cols="30s,70d"]
|===
| _English name_ | _has evidence type_
| URI |  cv:hasEvidenceType
| Verdiområde / _Range_ | <<Dokumentasjonstype, cv:EvidenceType>>
| Anvendelse / _Usage note_ |  Egenskapen brukes til å referere til dokumentasjonstype som spesifiserer type dokumentasjon som trengs for å tilfredsstille kriteriet.

_This property is used to refer to the Evidence Type that specifies the type of evidence that is needed to meet the Criterion._
| Multiplisitet / _Multiplicity_ | 0..n
| Kravnivå / _Requirement level_ | Valgfri / _Optional_
|===
