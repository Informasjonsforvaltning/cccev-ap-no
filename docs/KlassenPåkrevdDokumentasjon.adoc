== Klassen Påkrevd dokumentasjon (cccevno:RequiredEvidence) [[PåkrevdDokumentasjon]]

[[img-KlassenPåkrevdDokumentasjon]]
.Klassen Påkrevd dokumentasjon (cccevno:RequiredEvidence) og klassene den refererer til
...
==== Påkrevd dokumentasjon – gyldighetsperiode (cccevno:validityDuration) [[PåkrevdDokumentasjon-gyldighetsperiode]]

[cols="30s,70d"]
|===
| _English name_ |  _validity duration_
| URI | cccevno:validityDuration
...
-----
<påkrevdFirmaattest> a cccevno:RequiredEvidence ; 
   cccevno:validityDuration "P6M"^^xsd:duration ; . # 6 måneder
-----
...
==== Påkrevd dokumentasjon – er del av (dct:isPartOf) [[PåkrevdDokumentasjon-er-del-av]]
...
==== Påkrevd dokumentasjon – gir understøttende opplysning (cv:supportsValue) [[PåkrevdDokumentasjon-gir-understøttende-opplysning]]
...
| Anvendelse / _Usage note_ | Egenskapen brukes til å referere til understøttende opplysninger i den påkrevde dokumentasjonen.

_This property represents Supported Value that the Required Evidence contains._
| Multiplisitet / _Multiplicity_ | 0..n
| Kravnivå / _Requirement level_ | Valgfri / _Optional_
|===
...
==== Påkrevd dokumentasjon – i samsvar med (dct:conformsTo) [[PåkrevdDokumentasjon-i-samsvar-med]]
...
==== Påkrevd dokumentasjon – relatert informasjon (foaf:page) [[PåkrevdDokumentasjon-relatert-informasjon]]
...
==== Påkrevd dokumentasjon – understøtter informasjonsbegrep (cv:supportsConcept) [[PåkrevdDokumentasjon-understøtter-informasjonsbegrep]]
...
==== Påkrevd dokumentasjon – understøtter krav (cv:supportsRequirement) [[PåkrevdDokumentasjon-understøtter-krav]]
