...
__#@@@@@@ sjekk til slutt og ta bort navnerom som ikke brukes i spesifikasjonen#__
...
|cccevno | `\https://data.norge.no/vocabulary/cccevno#` | Norsk applikasjonsprofil av CCCEV, denne spesifikasjonen
...
|cpsvno | `\https://data.norge.no/vocabulary/cccevno#` | https://data.norge.no/specification/cpsv-ap-no#Dokumentasjonstype[Spesifikasjon for tjeneste- og hendelsesbeskrivelser (CPSV-AP-NO) &#x29C9;, window="_blank", role="ext-link"]
