...
| Anvendelse / _Usage note_ |  Egenskapen brukes til å referere til dokumentasjonstypeliste som spesifiserer type dokumentasjon som trengs for å tilfredsstille begrensningen.

_This property is used to refer to the Evidence Type List that specifies the type of evidence that are needed to meet the Constraint._
| Multiplisitet / _Multiplicity_ | 0..n
|Kravnivå / _Requirement level_ | Valgfri / _Optional_
|===
...
| Anvendelse / _Usage note_ |  Egenskapen brukes til å referere til regel som begrensningen innfrir.
