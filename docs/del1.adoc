...
* *Påpkrevd dokumentasjon* brukes til, i «_design-time_», å oppgi den påkrevde dokumentasjonen som _kan_ fremlegges og brukes til å evaluere om et krav er oppfylt eller ikke. Påpkrevd dokumentasjon brukes med andre ord i forbindelse med _beskrivelsen_ av en tjeneste, i f.eks. en tjenestekatalog. Eksempler på en påkrved dokumentasjon på en søkers alder kan være «Uttrekk fra Folkeregisteret», «Fødselsattest» eller «Førerkort»/«ID-kort»/«Pass».
