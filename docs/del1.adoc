...
=== Illustrative eksempler [[Illustrative-eksempler]]
//:xrefstyle: pass:[%n %t]
:xrefstyle: full

Se under <<Å-beskrive-betingelser-som-skal-oppfylles>> og <<Å-kytte-krav-til-regelverk>> for illustrative eksempler på bruk av CCCEV-AP-NO.