...
Følgende rader (ikke nødvendigvis i den rekkefølgen) er brukt i tabellene der krav til klasser og egenskaper i CCCEV-AP-NO er spesifisert:

__#@@@@@@ NB! Må gjennomgåes og ev. tilpasses CCCEV#__
