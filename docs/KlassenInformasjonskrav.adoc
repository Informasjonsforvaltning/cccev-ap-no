...
| Anvendelse / _Usage note_ | Egenskapen brukes til å referere til en dokumentasjon som supplerer med informasjon, bevis eller understøtter informasjonskravet.

_This property refers to an evidence that supplies information, proof or support for the information requirement._
| Multiplisitet / _Multiplicity_ | 0..n
| Kravnivå / _Requirement level_ | Valgfri / _Optional_
|===
