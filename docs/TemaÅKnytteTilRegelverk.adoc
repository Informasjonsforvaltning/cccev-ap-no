=== Å knytte krav til regelverk [[Å-knytte-krav-til-regelverk]]
...
Eksemplet er illustrert i <<img-Figur-eksempelkravbeskrivelse-med-regelverk>> nedenfor.

[[img-Figur-eksempelkravbeskrivelse-med-regelverk]]
.Eksempel på å knytte kravbeskrivelse til lovgivning
