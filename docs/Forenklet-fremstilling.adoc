...
|===
| Anbefalt | Forklaring | Ref. til Kap. <<Spesifikasjon-per-klasse>>
| gyldighetsperiode | Angir en tidsperiode som den påkrevd dokumentasjonen skal være gyldig innenfor | <<PåkrevdDokumentasjon-gyldighetsperiode>>
| språk | Språk som den påkrevde dokumentasjonen kan være på | <<PåkrevdDokumentasjon-språk>>
|===
...
|===
| Valgfri | Forklaring | Ref. til Kap. <<Spesifikasjon-per-klasse>>
| er del av | Refererer til et datasett som den aktuelle påkrevde dokumentasjonen fysisk eller logisk kan være inkludert i | <<PåkrevdDokumentasjon-er-del-av>>
...
| i samsvar med | Oppgir dokumentasjonstypen som den påkrevde dokumentasjonen skal være i samsvar med | <<PåkrevdDokumentasjon-i-samsvar-med>>
