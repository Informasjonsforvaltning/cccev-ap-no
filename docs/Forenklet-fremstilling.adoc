...
| tillatt gyldighetsperiode | Tidsperiode som dokumentasjoner tilhørende denne dokumentasjonstypen skal være gyldig innenfor | <<Dokumentasjonstype-tillatt-gyldighetsperiode>>
| tillatt språk | Språk som dokumentasjoner tilhørende denne dokumentasjonstypen kan være på | <<Dokumentasjonstype-tillatt-språk>>
|===
...
| er spesifisert i | Dokumentasjonstypeliste som inneholder dokumentasjonstypen | <<Dokumentasjonstypeliste-er-spesifisert-i>>
| relatert informasjon | Mer informasjon om den aktuelle type dokumentasjon | <<Dokumentasjonstypeliste-relatert-informasjon>>
| tillatt utstedelsessted | Utstedelsested som er tillatt for den aktuelle type dokumentasjon | <<Dokumentasjonstypeliste-tillatt-utstedelsessted>>
|===
