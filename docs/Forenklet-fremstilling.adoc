...
** Se <<Når-brukes-dokumentasjon-og-dokumentasjonstype-dokumentasjonstypeliste>> for mer forklaring på når Dokumentasjon, Dokumentasjonstype og Dokumentasjonstypeliste bør brukes.
