...
| har dokumentasjonstype | Refererer til dokumentasjonstype som spesifiserer type dokumentasjon som trengs for å tilfredsstille kravet | <<Begrensning-har-dokumentasjonstype>>, <<Informasjonskrav-har-dokumentasjonstype>>, <<Kriterium-har-dokumentasjonstype>>
