...
| har dokumentasjonstypeliste | Refererer til dokumentasjonstypeliste som spesifiserer type dokumentasjon som trengs for å tilfredsstille kravet | <<Begrensning-har-dokumentasjonstypeliste>>, <<Informasjonskrav-har-dokumentasjonstypeliste>>, <<Kriterium-har-dokumentasjonstypeliste>>
...
| innfrir regel | Refererer til regel som kravet innfrir | <<Begrensning-innfrir-regel>>, <<Informasjonskrav-innfrir-regel>>, <<Kriterium-innfrir-regel>>
...
| vekting | (Gjelder kun for Kriterium) Oppgir relativ viktighet (vekting) av Kriteriet | <<Kriterium-vekting>>
...
|===
| Obligatorisk | Forklaring | Ref. til kap. <<Spesifikasjon-per-klasse>>
| forventet datatype | Angir forventet datatype for verdien til informasjonsbegrepet (f.eks. heltall, dato eller kode) | <<Informasjonsbegrep-uttrykk-av-forventet-datatype>>
|===
...
|===
| Obligatorisk | Forklaring | Ref. til kap. <<Spesifikasjon-per-klasse>>
| beskrivelse | Tekstlig beskrivelse av dokumentasjonstype | <<Dokumentasjonstype-beskrivelse>>
| identifikator | Unik identifikator, som regel opprettet automatisk av et system | <<Dokumentasjonstype-identifikator>>
...
|===
| Anbefalt | Forklaring | Ref. til kap. <<Spesifikasjon-per-klasse>>
| tillatt gyldighetsperiode | Tidsperiode som dokumentasjoner av denne dokumentasjonstypen skal være gyldig innenfor | <<Dokumentasjonstype-tillatt-gyldighetsperiode>>
| tillatt språk | Språk som dokumentasjoner av denne dokumentasjonstypen kan være på | <<Dokumentasjonstype-tillatt-språk>>
|===
...
|===
| Valgfri | Forklaring | Ref. til kap. <<Spesifikasjon-per-klasse>>
| dokumentasjonstypekategori | Kategorien som dokumentasjontypen tilhører | <<Dokumentasjonstype-dokumentasjonstypekategori>>
| er beskrevet ved | Datasett som denne aktuelle type dokumentasjon kan være beskrevet ved. | <<Dokumentasjonstype-er-beskrevet-ved>>
| er spesifisert i | Dokumentasjonstypeliste som inneholder dokumentasjonstypen | <<Dokumentasjonstype-er-spesifisert-i>>
| relatert informasjon | Mer informasjon om den aktuelle type dokumentasjon | <<Dokumentasjonstype-relatert-informasjon>>
| tillatt utstedelsessted | Utstedelsested som er tillatt for den aktuelle type dokumentasjon | <<Dokumentasjonstype-tillatt-utstedelsessted>>
|===
...
|===
| Obligatorisk | Forklaring | Ref. til kap. <<Spesifikasjon-per-klasse>>
| spesifiserer dokumentasjonstype | Oppgir dokumentasjonstype som er spesifisert av dokumentasjonstypelisten | <<Dokumentasjonstypeliste-spesifiserer-dokumentasjonstype>>
|===
...
|===
| Anbefalt | Forklaring | Ref. til kap. <<Spesifikasjon-per-klasse>>
| beskrivelse | Tekstlig beskrivelse av dokumentasjonstypeliste | <<Dokumentasjonstypeliste-beskrivelse>>
| identifikator | Unik identifikator, som regel opprettet automatisk av et system | <<Dokumentasjonstypeliste-identifikator>>
