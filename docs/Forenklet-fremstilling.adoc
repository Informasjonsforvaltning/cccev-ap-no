...
* *Dokumentasjonstypeliste* brukes til, i «_design-time_», å oppgi typer dokumentajon som _kan_ fremlegges og brukes til å evaluere om et krav er oppfylt eller ikke. Dokumentasjonstypeliste brukes med andre ord i forbindelse med _beskrivelsen_ av en tjeneste, i f.eks. en tjenestekatalog. Eksempler på en dokumentasjonsliste kan være __#@@@@@@@ tekst kommer#__.
