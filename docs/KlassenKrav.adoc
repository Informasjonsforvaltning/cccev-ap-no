...
__#@@@@@@ NB! valgfri relasjon cv:hasSuppurtingEvindenc som peker til cv:Evidence (eller Påkrevd dokumentasjon) mangler både i tegningen og i teksten.#__

__#@@@@@@ ... og klassen cv:Evidence (eller Påkrevd dokumentasjon) bør tas med i oversikten.#__

__##@@@@@@ ... gjelder alle subklasser til denne klassen.#__
