...
«Norsk utvidelse» i merknad betyr avvik mellom CCCEV-AP-NO og EUs CCCEV. Der det ikke står noe om «norsk utvidelse» i merknad til en egenskap/klasse, er egenskapen/klassen brukt slik den er spesifisert i CCCEV. Der det står «norsk utvidelse» i merknad til en egenskap, er kravet til egenskapen endret (f.eks. med forklaringen noe a la "Kravnivået er endret fra valgfri til anbefalt"), eller at egenskapen ikke er å finne i CCCEV (f.eks. med forklaring "Ikke eksplisitt spesifisert i CCCEV."). 
...
_#@@@@@@ Egenskapene er ikke ennå grundig kryss-sjekket mot CCCEV og CPSV-AP (mtp. norske utvidelser)#_