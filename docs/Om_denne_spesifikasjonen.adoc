...
Formålet med spesifikasjonen er å legge til rette for en felles måte å beskrive krav og dokumentasjon av kravoppfyllese i forbindelse med f.eks. beskrivelse av en tjeneste, og en felles måte å utveksle beskrivelsene.  

=== Omfang og avgrensing [[Omfang-og-avgrensing]]

Spesifikasjonen er i utgangspunktet ikke tenkt å brukes alene. Den er ment å brukes f.eks. sammen med https://data.norge.no/specification/cpsv-ap-no[Spesifikasjon for tjeneste- og hendelsesbeskrivelser (CPSV-AP-NO) &#x29C9;, window="_blank", role="ext-link"], når det er behov for å beskrive, i strukturert form, krav og dokumentasjon av kravoppfyllelse til en tjeneste. 
